        ...
        children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.arrow_back_ios, color: primaryBlue, size: 18),
                    ),
                  ),
                ),
                // Doctor info on left
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(doctor.specialization, style: TextStyle(color: primaryBlue, fontSize: 12, fontWeight: FontWeight.w500)),
                      ),
                      SizedBox(height: 10),
                      Text(
                        doctor.name,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _statCard(Icons.people, '1000+', 'Patients', Colors.blue.shade50, primaryBlue),
                _divider(),
                _statCard(Icons.work_outline, '${doctor.experience} yrs', 'Experience', Colors.orange.shade50, Colors.orange),
                _divider(),
                _statCard(Icons.star, '${doctor.rate}', 'Rating', Colors.amber.shade50, Colors.amber),
              ],
            ),
          ),
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("About Doctor", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
                  SizedBox(height: 10),
                  Text(
                  ...
                  // Info cards
                  Text("Information", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
                  SizedBox(height: 12),
                  _infoCard(Icons.local_hospital, "Hospital", doctor.hospital),
                  SizedBox(height: 10),
                  _infoCard(Icons.medical_services, "Specialty", doctor.specialization),
                  SizedBox(height: 10),
                  _infoCard(Icons.work_outline, "Experience", "${doctor.experience} years"),
                  SizedBox(height: 10),
                  _infoCard(Icons.star, "Rating", "${doctor.rate} / 5.0"),
                ],
              ),
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              boxShadow: [BoxShadow(color: Colors.grey.shade200, blurRadius: 10, offset: Offset(0, -3))],
            ),
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text("Book Appointment", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
  ...
  Widget _statCard(IconData icon, String value, String label, Color bgColor, Color iconColor) {
    return Column(
      children: [
        ...
        SizedBox(height: 6),
        Text(value, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.black87)),
